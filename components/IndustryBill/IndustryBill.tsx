...
interface IndustryBillProps {
  industryBill: IndustryBillType;
  fee: Fee;
}

/** @TODO check details */
const IndustryBill = forwardRef((props: IndustryBillProps, ref) => {
  const { industryBill, fee } = props;

  const electricNumberInfos = useMemo(() => {
    // const f = industryBill.electricNumberInfos.map((x) => x.number === );
  }, [industryBill]);
    ...
    <Box sx={styles.container} ref={ref}>
      ...
      <Box sx={{ margin: "46px 84px" }}>
        <Box sx={{ display: "flex", columnGap: "12px" }}>
          <Typography variant="h6">{industryBill.contactName}</Typography>
          <Typography variant="h6" sx={{ fontWeight: 500 }}>
            聯絡人
          </Typography>
        </Box>
        <Typography variant="body4">{industryBill.address}</Typography>
      </Box>
      <Grid container spacing={"8px"}>
        ...
        <Grid item sm={6}>
          ...
          <Box sx={styles.box}>
            <Typography variant="h5" sx={{ color: "#009688" }}>
              {industryBill.estimatedBillDeliverDate}
            </Typography>
          </Box>
        </Grid>
        {/* <Grid item sm={4}>
            ...
            >
              ...
              >
                ...
                <Typography variant="menuType">
                  {`${industryBill.recipientAccount.bankCode}`}
                </Typography>
              </Box>
              <Box
                sx={{
              ...
              >
                ...
                <Typography variant="menuType">
                  {industryBill.recipientAccount.account}
                </Typography>
              </Box>
            </Box>
          </Box>
...
IndustryBill.displayName = "IndustryBill";
export default IndustryBill;
