...
import { IndustryBillBatchAuditModal } from "./IndustryBillBatchAuditModal";
...
const IndustryBillPanel = (props: IndustryBillPanelProps) => {
  ...
  const currentList = useMemo<IndustryBill[]>(
    () => (data?.industryBills?.list as IndustryBill[]) ?? [],
