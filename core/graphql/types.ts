...
export type IndustryBill = {
  ...
  /** 系統生成的 PDF 下載 URL */
  generatedPdfDownloadUrl?: Maybe<Scalars['String']['output']>;
  id: Scalars['ID']['output'];
  /** 手動匯入時間 */
  importedAt?: Maybe<Scalars['DateTime']['output']>;
  /** 手動匯入者 */
  importedBy?: Maybe<Admin>;
  industryBillConfig?: Maybe<IndustryBillConfig>;
  /** 手動匯入記錄 */
  manualImportRecord?: Maybe<ManualIndustryBillImport>;
  name: Scalars['String']['output'];
  /** 手動匯入原始檔案下載 URL */
...
export type ManualIndustryBillImport = {
  __typename?: 'ManualIndustryBillImport';
  /** 原始檔名 */
  fileName: Scalars['String']['output'];
  /** 生成的 PDF 下載 URL */
  generatedPdfDownloadUrl?: Maybe<Scalars['String']['output']>;
  /** 生成的 PDF S3 key */
  generatedPdfKey?: Maybe<Scalars['String']['output']>;
  id: Scalars['ID']['output'];
  /** 匯入時間 */
  importedAt: Scalars['DateTime']['output'];
  /** 匯入者 ID */
  importedBy: Scalars['ID']['output'];
  industryBillId: Scalars['ID']['output'];
  /** 原始檔案下載 URL */
  originalFileDownloadUrl?: Maybe<Scalars['String']['output']>;
  /** 原始檔案 S3 key */
...
export type ManualUserBillImport = {
  __typename?: 'ManualUserBillImport';
  /** 原始檔名 */
  fileName: Scalars['String']['output'];
  /** 生成的 PDF 下載 URL */
  generatedPdfDownloadUrl?: Maybe<Scalars['String']['output']>;
...
export type QueryFindIndustryBillByElectricNumberAndMonthArgs = {
  billingMonth: Scalars['String']['input'];
  electricNumber: Scalars['String']['input'];
  industryBillConfigId: Scalars['String']['input'];
};
...
export type UserBill = {
  ...
  importedBy?: Maybe<Admin>;
  /** 手動匯入記錄 */
  manualImportRecord?: Maybe<ManualUserBillImport>;
  name: Scalars['String']['output'];
  /** 手動匯入原始檔案下載 URL */
  originalFileDownloadUrl?: Maybe<Scalars['String']['output']>;
  status: ElectricBillStatus;
